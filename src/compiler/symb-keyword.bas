...
{ _
	...
	( @"INSTRI"     , FB_TK_INSTRI      , FB_TKCLASS_QUIRKWD ), _
	( @"INSTRREV"   , FB_TK_INSTRREV    , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
	( @"INSTRREVI"  , FB_TK_INSTRREVI   , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
	( @"TRIM"       , FB_TK_TRIM        , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
	( @"TRIMI"      , FB_TK_TRIMI       , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
	( @"RTRIM"      , FB_TK_RTRIM       , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"RTRIMI"     , FB_TK_RTRIMI      , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"LTRIM"      , FB_TK_LTRIM       , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"LTRIMI"     , FB_TK_LTRIMI      , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"REPLACE"    , FB_TK_REPLACE     , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"SUBSTRCOUNT" , FB_TK_SUBSTRCOUNT , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
	( @"STRCOMP"    , FB_TK_STRCOMP     , FB_TKCLASS_QUIRKWD , KWD_OPTION_STRSUFFIX ), _
