...
#include once "rtl.bi"
	...
	{ _
		...
		/' function fb_StrInstrEx( byval start as const integer, byref src as const string, _
				byref patt as const string, byval fbCompareType as const integer ) as integer '/ _
		( _
			@FB_RTL_STRINSTREX, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			4, _
			{ _
		...
		/' function fb_StrInstr2( byval start as const integer, byref src as const string, byref patt1 as const string, _
				byref patt2 as const string, byval fbCompareType as const integer, byref betweensize as integer ) as integer '/ _
		( _
			@FB_RTL_STRINSTR2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
				...
				( typeSetIsConst( FB_DATATYPE_STRING ), FB_PARAMMODE_BYREF, FALSE ), _
				( typeSetIsConst( FB_DATATYPE_INTEGER ), FB_PARAMMODE_BYVAL, FALSE ), _
				( typeSetIsConst( FB_DATATYPE_INTEGER ), FB_PARAMMODE_BYREF, FALSE ) _
			} _
 		), _
		...
		/' function fb_WstrInstrEx( byval start as const integer, byval src as const wstring ptr, _
				byval patt as const wstring ptr, byval fbCompareType as const integer ) as integer '/ _
		( _
			@FB_RTL_WSTRINSTREX, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			4, _
			{ _
		...
		/' function fb_WstrInstr2( byval start as const integer, byval src as const wstring ptr, byval patt1 as const wstring ptr, _
				byval patt2 as const wstring ptr, byval fbCompareType as const integer, byref betweensize as integer ) as integer '/ _
		( _
			@FB_RTL_WSTRINSTR2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_StrInstrExAny( byval start as const integer, byref src as const string, _
				byref pattern as const string, byval fbCompareType as const integer ) as integer '/ _
		( _
			@FB_RTL_STRINSTREXANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			4, _
			{ _
		...
		/' function fb_StrInstr2Any( byval start as const integer, byref src as const string, byref pattern1 as const string, _
				byref pattern2 as const string, byval fbCompareType as const integer, byref betweensize as integer ) as integer '/ _
		( _
			@FB_RTL_STRINSTR2ANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_WstrInstrExAny( byval start as const integer, byval src as const wstring ptr, _
				byval pattern as const wstring ptr, byval fbCompareType as const integer ) as integer '/ _
		( _
			@FB_RTL_WSTRINSTREXANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			4, _
			{ _
		...
		/' function fb_WstrInstr2Any( byval start as const integer, byval src as const wstring ptr, byval pattern1 as const wstring ptr, _
				byval pattern2 as const wstring ptr, byval fbCompareType as const integer, byref betweensize as integer ) as integer '/ _
		( _
			@FB_RTL_WSTRINSTR2ANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_TrimIAny( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRTRIMIANY, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrTrimIAny( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRTRIMIANY, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_TrimIEx( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRTRIMIEX, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrTrimIEx( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRTRIMIEX, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_RTrimIAny( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRRTRIMIANY, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrRTrimIAny( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRRTRIMIANY, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_RTrimIEx( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRRTRIMIEX, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrRTrimIEx( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRRTRIMIEX, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_LTrimIAny( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRLTRIMIANY, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrLTrimIAny( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRLTRIMIANY, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_LTrimIEx( byref str as const string, byref pattern as const string ) as string '/ _
		( _
			@FB_RTL_STRLTRIMIEX, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_WstrLTrimIEx( byval str as const wstring ptr, byval pattern as const wstring ptr ) as wstring '/ _
		( _
			@FB_RTL_WSTRLTRIMIEX, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			2, _
			{ _
		...
		/' function fb_Replace( byref src as const string, byref find as const string, _
		         ...
		         byval fbCompareType as const integer) as string '/ _
		( _
		...
		/' function fb_Replace2( byref src as const string, byref find1 as const string, byref find2 as const string, _
		         byref replaceWith as const string, byval Start as const integer, byval Count as const integer, _
		         byval fbCompareType as const integer) as string '/ _
		( _
			@FB_RTL_STRREPLACE2, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			7, _
			{ _
		...
		/' function fb_WstrReplace2( byval src as const wstring ptr, byval find1 as const wstring ptr, byval find2 as const wstring ptr, _
		         byval replaceWith as const wstring ptr, byval Start as const integer, byval Count as const integer, _
		         byval fbCompareType as const integer) as string '/ _
		( _
			@FB_RTL_WSTRREPLACE2, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			7, _
			{ _
		...
		/' function fb_ReplaceAny2( byref src as const string, byref find1 as const string, byref find2 as const string, _
		         byref replaceWith as const string, byval Start as const integer, byval Count as const integer, _
		         byval fbCompareType as const integer) as string '/ _
		( _
			@FB_RTL_STRREPLACEANY2, NULL, _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			7, _
			{ _
		...
		/' function fb_WstrReplaceAny2( byval src as const wstring ptr, byval find1 as const wstring ptr, byval find2 as const wstring ptr, _
		         byval replaceWith as const wstring ptr, byval Start as const integer, byval Count as const integer, _
		         byval fbCompareType as const integer) as string '/ _
		( _
			@FB_RTL_WSTRREPLACEANY2, NULL, _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			7, _
			{ _
		...
		/' function fb_SubStrCount( byref src as const string, byref find as const string, byval Start as const integer, byval fbCompareType as const integer) as integer '/ _
		( _
		...
		/' function fb_SubStrCount2( byref src as const string, byref find1 as const string, byref find2 as const string, byval Start as const integer, byval fbCompareType as const integer, byref betweensize as integer) as integer '/ _
		( _
			@FB_RTL_STRSUBSTRCOUNT2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_WstrStrCount( byval src as const wstring ptr, byval find as const wstring ptr, byval Start as const integer, byval fbCompareType as const integer) as integer '/ _
		( _
		...
		/' function fb_WstrStrCount2( byval src as const wstring ptr, byval find1 as const wstring ptr, byval find2 as const wstring ptr, byval Start as const integer, byval fbCompareType as const integer, byref betweensize as integer) as integer '/ _
		( _
			@FB_RTL_WSTRSUBSTRCOUNT2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_SubStrCountAny( byref src as const string, byref find as const string, byval Start as const integer, byval fbCompareType as const integer) as integer '/ _
		( _
		...
		/' function fb_SubStrCountAny2( byref src as const string, byref find1 as const string, byref find2 as const string, byval Start as const integer, byval fbCompareType as const integer, byref betweensize as integer) as integer '/ _
		( _
			@FB_RTL_STRSUBSTRCOUNTANY2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_WstrStrCountAny( byval src as const wstring ptr, byval find as const wstring ptr, byval Start as const integer, byval fbCompareType as const integer) as integer '/ _
		( _
		...
		/' function fb_WstrStrCountAny2( byval src as const wstring ptr, byval find1 as const wstring ptr, byval find2 as const wstring ptr, byval Start as const integer, byval fbCompareType as const integer, byref betweensize as integer) as integer '/ _
		( _
			@FB_RTL_WSTRSUBSTRCOUNTANY2, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			6, _
			{ _
		...
		/' function fb_StrComp( byval src as const string ptr, byval find as const string ptr, _
		         byval replaceWith as const wstring ptr, byval fbCompareType as const integer, byval Start as const integer, _
		         byval Count as const integer) as integer '/ _
		( _
			@FB_RTL_STRSTRCOMP, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			5, _
			{ _
		...
		/' function fb_StrCompAny( byval src as const string ptr, byval find as const string ptr, _
		         byval replaceWith as const wstring ptr, byval fbCompareType as const integer, byval Start as const integer, _
		         byval Count as const integer) as integer '/ _
		( _
			@FB_RTL_STRSTRCOMPANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			5, _
			{ _
		...
		/' function fb_WstrStrComp( byval src as const wstring ptr, byval find as const wstring ptr, _
		         byval replaceWith as const wstring ptr, byval fbCompareType as const integer, byval Start as const integer, _
		         byval Count as const integer) as integer '/ _
		( _
			@FB_RTL_WSTRSTRCOMP, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			5, _
			{ _
		...
		/' function fb_WstrStrCompAny( byval src as const wstring ptr, byval find as const wstring ptr, _
		         byval replaceWith as const wstring ptr, byval fbCompareType as const integer, byval Start as const integer, _
		         byval Count as const integer) as integer '/ _
		( _
			@FB_RTL_WSTRSTRCOMPANY, NULL, _
			FB_DATATYPE_INTEGER, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NONE, _
			5, _
			{ _
...
function rtlStrInstrEx _
	...
	''
    if( search_any and FB_HasBothAnyKey )<>0 then
       if nd_find2 = NULL then
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRINSTREXANY )
   		else
   			f = PROCLOOKUP( WSTRINSTREXANY )
   		end if
       else
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRINSTR2ANY )
   		else
   			f = PROCLOOKUP( WSTRINSTR2ANY )
   		end if
       end if
    else
       if nd_find2 = NULL then
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRINSTREX )
   		else
   			f = PROCLOOKUP( WSTRINSTREX )
   		end if
       else
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRINSTR2 )
   		else
   			f = PROCLOOKUP( WSTRINSTR2 )
   		end if
       end if
    end if
    ...
    if( astNewARG( proc, nd_find1 ) = NULL ) then
    	exit function
    end if
    
    if nd_find2<>NULL AndAlso( astNewARG( proc, nd_find2 ) = NULL ) then
    	exit function
    end if
    
    if( astNewARG( proc, nd_fbCompareType ) = NULL ) then
    	exit function
    end if
    if nd_betweensize<>NULL AndAlso( astNewARG( proc, nd_betweensize ) = NULL ) then
    	exit function
    end if
...
function rtlStrTrimI _
    ...
    if( is_any ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRTRIMIANY )
		else
			f = PROCLOOKUP( WSTRTRIMIANY )
		end if
    elseif( nd_pattern <> NULL ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRTRIMIEX )
		else
			f = PROCLOOKUP( WSTRTRIMIEX )
		end if
    else
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRTRIM )
...
function rtlStrRTrimI _
    ...
    if( is_any ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRRTRIMIANY )
		else
			f = PROCLOOKUP( WSTRRTRIMIANY )
		end if
    elseif( nd_pattern <> NULL ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRRTRIMIEX )
		else
			f = PROCLOOKUP( WSTRRTRIMIEX )
		end if
    else
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRRTRIM )
...
function rtlStrLTrimI _
    ...
    if( is_any ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRLTRIMIANY )
		else
			f = PROCLOOKUP( WSTRLTRIMIANY )
		end if
    elseif( nd_pattern <> NULL ) then
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRLTRIMIEX )
		else
			f = PROCLOOKUP( WSTRLTRIMIEX )
		end if
    else
		if( dtype <> FB_DATATYPE_WCHAR ) then
			f = PROCLOOKUP( STRLTRIM )
...
function rtlStrReplace _
    ...
    if ( search_any and FB_HasBothAnyKey )<>0 then    
       if nd_find2 = NULL then
   		...
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRREPLACEANY2 )
   		else
   			f = PROCLOOKUP( WSTRREPLACEANY2 )
   		end if
       end if
    else    
       if nd_find2 = NULL then
   		...
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRREPLACE2 )
   		else
   			f = PROCLOOKUP( WSTRREPLACE2 )
   		end if
       end if
    end if
...
function rtlStrSubStrCount _
    ...
    if( search_any and FB_HasBothAnyKey )<>0 then
       if nd_find2 = NULL then
   		...
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRSUBSTRCOUNTANY2 )
   		else
   			f = PROCLOOKUP( WSTRSUBSTRCOUNTANY2 )
   		end if
       end if
    else
       if nd_find2 = NULL then
   		...
   		if( dtype <> FB_DATATYPE_WCHAR ) then
   			f = PROCLOOKUP( STRSUBSTRCOUNT2 )
   		else
   			f = PROCLOOKUP( WSTRSUBSTRCOUNT2 )
   		end if
       end if
    end if
...
function rtlStrComp _
   ...
   if( search_any ) then
   	if( dtype <> FB_DATATYPE_WCHAR ) then
   		f = PROCLOOKUP( STRSTRCOMPANY )
   	else
   		f = PROCLOOKUP( WSTRSTRCOMPANY )
   	end if
   else
      if( dtype <> FB_DATATYPE_WCHAR ) then
      	f = PROCLOOKUP( STRSTRCOMP )
      else
      	f = PROCLOOKUP( WSTRSTRCOMP )
      end if
   end if
    ...
    if( astNewARG( proc, nd_MaxCount ) = NULL ) then
    	exit function
    end if
