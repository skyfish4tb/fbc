...
FBCALL ssize_t      fb_StrInstrI        ( ssize_t start, FBSTRING *src, FBSTRING *patt );
...
FBCALL ssize_t      fb_StrInstrRevI     ( FBSTRING *src, FBSTRING *patt, ssize_t start );
...
FBCALL ssize_t      fb_WstrInstrRevI    ( const FB_WCHAR *src, const FB_WCHAR *patt, ssize_t start );
