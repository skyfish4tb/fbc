...
namespace fbc_tests.structs.generated.bitfield_layout_64_25
...
scope
	...
	x.a = &b1111111111111111111111111
	CU_ASSERT( p[0] = 255 )
	CU_ASSERT( p[1] = 255 )
	CU_ASSERT( p[2] = 255 )
	CU_ASSERT( p[3] = 1 )
	CU_ASSERT( x.a = &b1111111111111111111111111 )
end scope
...
private sub ctor( ) constructor
	fbcu.add_suite( "tests/structs/bitfield_layout_64_25" )
