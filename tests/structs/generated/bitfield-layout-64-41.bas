...
namespace fbc_tests.structs.generated.bitfield_layout_64_41
...
scope
	...
	x.a = &b11111111111111111111111111111111111111111ll
	CU_ASSERT( p[0] = 255 )
	CU_ASSERT( p[1] = 255 )
	CU_ASSERT( p[2] = 255 )
	CU_ASSERT( p[3] = 255 )
	...
	CU_ASSERT( p[6] = 0 )
	CU_ASSERT( p[7] = 0 )
	CU_ASSERT( x.a = &b11111111111111111111111111111111111111111ll )
end scope
...
private sub ctor( ) constructor
	fbcu.add_suite( "tests/structs/bitfield_layout_64_41" )
